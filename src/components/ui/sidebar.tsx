...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
    ...
    return (
        <div ref={ref} className={cn('group peer w-[16rem] text-sidebar-foreground transition-[opacity,visibility,width] md:block', preview && 'invisible w-0 opacity-0')} data-state={state} data-collapsible={state === 'collapsed' ? collapsible : ''} data-variant={variant} data-side={side}>
